	...
	<div class="wrap">
		...
		<div id="container">
			...
			<div class="main1">
				...
				<div class="msImg">
					<a href="#"><img src="../resources/img/tea_time1.jpg"
						class="magazine"></a>
				</div>
				<!--msImg-->
				...
				<div class="msPager">
					<ul>
						...
						<li><a href="#">숫자로보는<br>오설록
						</a></li>
						<li class="on"><a href="#">차<br>하우스
						</a></li>
					</ul>
				</div>
			</div>
			...
			<section class="main2">
				<h2>차 알아보기</h2>
				<ul>
					<li class="tea1"><a href="#">
							<p class="over">
								<span>명차</span>
							</p>
					</a></li>
					<li class="tea2"><a href="#">
							<p class="over">
								<span>녹차/발효차/홍차</span>
							</p>
					</a></li>
					<li class="tea3"><a href="#">
							<p class="over">
								<span>건강차</span>
							</p>
					</a></li>
					<li class="tea4"><a href="#">
							<p class="over">
								<span>꽃/과일차</span>
							</p>
					</a></li>
			...
			<section class="main3">
				...
				<form id="actionForm" action="/osulloc/page/mainpage" method="get">
					<div class="taste">
						...
						</select> <select name="scent" id="" class="t_scent">
							<option>향</option>
						...
						</select> <select name="type" id="" class="t_product">
							<option>상품타입</option>
						...
						<div>
							<input type="submit" value="검색" id="proSubmit">
						</div>
						...
						<c:forEach items="${product}" var="product">
							<li>
								<div class="m3_item_box">
									<p class="m3_ib_img">
										<a
											href="/osulloc/page/detailProduct?prodnum=${product.prodnum}">
											<img src="/osulloc/display?fileName=${product.filename}"
											alt="">
										</a>
									</p>
									<p>
										<input type="hidden" value="${product.prodnum}">
									</p>
									<p class="m3_ib_name">
										<a
											href="/osulloc/page/detailProduct?prodnum=${product.prodnum}">${product.name}</a>
									</p>
						...
						<c:forEach items="${product2}" var="product2">
							<li>
								<div class="m4_item_box">
									<p class="m4_ib_img">
										<a
											href="/osulloc/page/detailProduct?prodnum=${product2.prodnum}">
											<img src="/osulloc/display?fileName=${product2.filename}" />
										</a>
									</p>
									<p>
										<input type="hidden" value="${product2.prodnum}"
											name="prodnum">
									</p>
									<p class="m4_ib_name">
									...
									<p>
										<span class="m4_ib_prise">${product2.price}원</span> <span
											class="m4_ib_prise_d">${product2.sale}원</span> &nbsp;
