					...
					<ul>
						<div class="welcome">
							<c:if test="${login != null }">
								<p>${login.id}님환영 합니다.</p>
								<li><a id="logout"
									onclick="location.href='/osulloc/member/logout'">로그아웃</a></li>
							</c:if>
							<c:if test="${login == null}">
								<li><a href="/osulloc/member/login">로그인</a></li>
							</c:if>
						</div>
			...
			<div class="gnb">
				<div class="gnb-in">
					<ul>
						...
						<li><a href="/osulloc/page/subpage">그 외 이야기</a>
							<div class="menus">
								<ul>
